...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <?=$this->Element('actions',array('type'=>'Doctor'));?>
</nav>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('Accepting Patients') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($doctor->name) ?></td>
                <td><?php if($doctor->accepting_patients == 1):?>
                    <span style="color:green" class="glyphicon glyphicon-ok">Yes</span>
                <?php else : ?>
                    <span style="color:red" class="glyphicon glyphicon-remove">No</span>
                <?php endif; ?></td>
                <td class="actions">
